...
public class HelpPanelGUI : PanelGuiBase
{
	...
	private void DrawGameplayGroup()
	{
		...
		yOffset = DrawGroupLabel(yOffset, "Splatting an Enemy", "When you deal the final blow to an enemy you get " + XpPointsUtil.Config.XpKill + " XP.");
		yOffset = DrawGroupLabel(yOffset, "Headshot Splats", "When you take down an enemy with a headshot you get " + XpPointsUtil.Config.XpHeadshot + " XP.");
		yOffset = DrawGroupLabel(yOffset, "Nutshot Splats", "When you take down an enemy with a nutshot you get " + XpPointsUtil.Config.XpNutshot + " XP.");
		yOffset = DrawGroupLabel(yOffset, "Melee Splats", "When you splat an enemy with a melee weapon you get " + XpPointsUtil.Config.XpSmackdown + " XP.");
