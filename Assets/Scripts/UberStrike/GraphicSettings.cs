...
internal static class GraphicSettings
{
	public static void SetQualityLevel(int level)
	{
		...
		case 2:
			...
			ApplicationDataManager.ApplicationOptions.VideoWaterMode = ((Application.platform == RuntimePlatform.OSXPlayer || Application.platform == RuntimePlatform.LinuxPlayer) ? 1 : 2);
			ApplicationDataManager.ApplicationOptions.VideoPostProcessing = true;
			break;
		}
	}
