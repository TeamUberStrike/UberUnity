...
public class ProjectileDetonator
{
	...
	{
		RaycastHit hitInfo;
		if (!Physics.Linecast(explosionPoint, hitPoint, out hitInfo, UberstrikeLayerMasks.ProtectionMask) || hitInfo.transform == shootable.Transform || hitInfo.transform.GetComponent<BaseGameProp>() != null)
		{
