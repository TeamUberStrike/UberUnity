...
internal class ValuablePlayerListGUI
{
	...
	private readonly float[] _columnWidthPercent = new float[4] { 0.7f, 0.1f, 0.1f, 0.1f };

	private readonly string[] _headingArray = new string[4] { "NAME", "KILL", "DEATHS", "LEVEL" };
	...
	public float Height
	{
		get
		{
			return 20f + _playerListViewHeight + 2f;
		}
	}
