...
public static class NGUIMath
{
	...
	public static Vector3 ApplyHalfPixelOffset(Vector3 pos)
	{
		...
		if (platform == RuntimePlatform.WindowsPlayer || platform == RuntimePlatform.LinuxPlayer || platform == RuntimePlatform.WindowsEditor || platform == RuntimePlatform.XboxOne)
		{
			pos.x -= 0.5f;
			pos.y += 0.5f;
		}
