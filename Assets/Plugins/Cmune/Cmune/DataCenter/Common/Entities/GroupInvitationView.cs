...
namespace Cmune.DataCenter.Common.Entities
{
	...
	public class GroupInvitationView
	{
		...
		{
			string text = "[GroupInvitationDisplayView: [InviterCmid: " + InviterCmid + "][InviterName: " + InviterName + "]";
			string text2 = text;
			text = text2 + "[GroupName: " + GroupName + "][GroupTag: " + GroupTag + "][GroupId: " + GroupId + "]";
			text2 = text;
			text = text2 + "[GroupInvitationId:" + GroupInvitationId + "][InviteeCmid:" + InviteeCmid + "][InviteeName:" + InviteeName + "]";
