...
namespace Cmune.DataCenter.Common.Entities
{
	...
	public class BasicClanView
	{
		...
		{
			string text = "[Clan: [Id: " + GroupId + "][Members count: " + MembersCount + "][Description: " + Description + "]";
			string text2 = text;
			...
			text2 = text;
			return text2 + "[Application Id: " + ApplicationId + "][Owner Cmid: " + OwnerCmid + "][Owner name: " + OwnerName + "]]";
		}
	}
}
